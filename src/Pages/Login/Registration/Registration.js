  ...
  const [agreement,setAgreement]=useState(false);
    ...
    return (
      ...
      <Form.Group className="mb-3" id="formGridCheckbox">
        <Form.Check onClick={()=>setAgreement(!agreement)} ref={agreementRef} type="checkbox" label="Agree to the terms and condition" />
      </Form.Group>
        
        <Button disabled={agreement ? false : true} className='d-block w-100 btn-success' variant="primary" type="submit">
         Signup
        </Button>
